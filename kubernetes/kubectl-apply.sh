...
logSummary() {
    echo ""
        ...
        echo "JHipster Grafana - http://jhipster-grafana.store."
        echo "#####################################################"
}
...
default() {
	...
	#kubectl apply -n store -f https://raw.githubusercontent.com/prometheus-operator/prometheus-operator/master/bundle.yaml
