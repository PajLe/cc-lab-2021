...
```
$ docker image tag gateway pajle/gateway
$ docker push pajle/gateway
$ docker image tag invoice pajle/invoice
$ docker push pajle/invoice
$ docker image tag notification pajle/notification
$ docker push pajle/notification
$ docker image tag productorder pajle/productorder
$ docker push pajle/productorder
```
